...
----------------------------------------------------
--        Jungle Tree from Sapling Schematic      --
----------------------------------------------------
...
-- tree from sapling schematic
local _ = {name = "air", prob = 0}
local L = {name = jungle_leaves, prob = 255}
local N = {name = jungle_leaves, prob = 223}
local M = {name = jungle_leaves, prob = 191}
local B = {name = jungle_trunk, prob = 255}
local C = {name = jungle_trunk, prob = 255, force_place = true}
local Y = {name = jungle_trunk, prob = 191}
local U = {name = jungle_trunk, prob = 127}

path.jungle_tree_sapling = {
	size = {x = 5, y = 17, z = 5},
	yslice_prob = {
		{ypos=6, prob=191},
		{ypos=7, prob=191},
